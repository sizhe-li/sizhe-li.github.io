...
**Research Objectives.** I build the brains and bodies of robots. My research draws ideas from machine learning, physics, and cognitive AI, with applications in robotics, computer vision, and computer graphics. 

More brodaly, I take a physics-based perspective to the study of intelligent systems on the tasks of inference and learning. This does not always mean injecting physics inductive biases into the system, but instead examining the (deep) learning systems like a physicist and understanding the mechanisms behind generalization and inference.
