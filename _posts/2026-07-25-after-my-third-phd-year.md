---
layout: post
title: "After My Third PhD Year: Reflections on My Research Direction"
date: 2026-07-25
description: "A bilingual reflection on physical priors, generative video models, and robot learning after my third PhD year."
author: Lester Li
...
<div class="bilingual-post">
  <input class="bilingual-post__choice" type="radio" name="reflection-language" id="reflection-lang-en" checked>
  <input class="bilingual-post__choice" type="radio" name="reflection-language" id="reflection-lang-zh">

  <div class="bilingual-post__controls" role="group" aria-label="Choose article language">
    <label for="reflection-lang-en" lang="en">English</label>
    <label for="reflection-lang-zh" lang="zh-CN">中文</label>
  </div>

  <section class="bilingual-post__panel bilingual-post__panel--en" lang="en" aria-label="English version">
    <p class="bilingual-post__lead">
    ...
    <p> I am grateful to everyone working together to explore the future of AI. </p>

  </section>

  <section class="bilingual-post__panel bilingual-post__panel--zh" lang="zh-CN" aria-label="中文版本">
    <h2>博士三年级之后：关于研究方向的一些回顾</h2>
